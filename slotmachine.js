...
function updateSpinButton() {
  if (spinText) {
    spinText.setText(autoSpin ? "STOP" : "SPIN");
  }
}
...
function resizeUI(gameSize) {
  ...
  if (width > height) {
    ...
    spinText.setFontSize(48 * scaleFactor);
    ...
    spinText.setPosition(uiX, height / 2);
    ...
    spinText.setFontSize(72 * scaleFactor);
